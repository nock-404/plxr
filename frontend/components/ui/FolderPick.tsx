...
import { parent, segments } from "@/lib/paths";
 ...
 */
/* Both separators, because plxr runs on Windows too — parent() and segments()
   live in lib/paths now, where the file tree's breadcrumb reads them from the
   same copy. */
