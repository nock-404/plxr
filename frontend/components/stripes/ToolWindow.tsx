 ...
 * instead, the way every editor draws one: its mark and its name, and on the
 * right a menu and a — that puts it away. There is no ×, because a tool is
 * never closed; it is hidden, and it comes back from its edge.
 *
