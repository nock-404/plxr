...
const (
	StatusWorking    Status = "working"    // the agent is working
...
type Session struct {
	...
	Agent           string `json:"agent,omitempty"`       // detected CLI, e.g. "claude"
	AgentLabel      string `json:"agent_label,omitempty"` // display name for it
